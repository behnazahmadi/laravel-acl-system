...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset("domain/assets/css/bootstrap.min.css")}}">
    <!-- Icon -->
    <link rel="stylesheet" href="{{asset("domain/assets/fonts/line-icons.css")}}">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="{{asset("domain/assets/css/owl.carousel.min.css")}}">
    <link rel="stylesheet" href="{{asset("domain/assets/css/owl.theme.css")}}">

    <!-- Animate -->
    <link rel="stylesheet" href="{{asset("domain/assets/css/animate.css")}}">
    <!-- Main Style -->
    <link rel="stylesheet" href="{{asset("domain/assets/css/main.css")}}">
    <!-- Responsive Style -->
    <link rel="stylesheet" href="{{asset("domain/assets/css/responsive.css")}}">
    ...
    <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand">
                <img src="{{asset("domain/assets/img/logo.png")}}" alt="">
            </a>
                ...
                <ul class="navbar-nav mr-auto w-100 justify-content-end clearfix">
                    ...
                    <!-- Dropdown Menu for Authenticated Users -->
                        <li class="nav-item dropdown">
                            ...
                            User Area  <i class="fas fa-chevron-down"></i>
                            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="intro-img">
                        <img class="img-fluid" src="{{asset("domain/assets/img/intro-mobile.png")}}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-xs-12 wow fadeInRight" data-wow-delay="0.3s">
                <img class="img-fluid" src="{{asset("domain/assets/img/about/img-1.png")}}" alt="" >
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="show-box wow fadeInUp" data-wow-delay="0.3s">
                    <img src="{{asset("domain/assets/img/feature/intro-mobile.png")}}" alt="">
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-xs-12">
                ...
                <div class="team-item wow fadeInRight" data-wow-delay="0.2s">
                    <div class="team-img">
                        <img class="img-fluid" src="{{asset("domain/assets/img/team/team-01.png")}}" alt="">
                    </div>
                    <div class="contetn">
                        <div class="info-text">
            ...
            <div class="col-lg-6 col-md-12 col-xs-12">
                ...
                <div class="team-item wow fadeInRight" data-wow-delay="0.4s">
                    <div class="team-img">
                        <img class="img-fluid" src="{{asset("domain/assets/img/team/team-02.png")}}" alt="">
                    </div>
                    <div class="contetn">
                        <div class="info-text">
            ...
            <div class="col-lg-6 col-md-12 col-xs-12">
                ...
                <div class="team-item wow fadeInRight" data-wow-delay="0.6s">
                    <div class="team-img">
                        <img class="img-fluid" src="{{asset("domain/assets/img/team/team-03.png")}}" alt="">
                    </div>
                    <div class="contetn">
                        <div class="info-text">
            ...
            <div class="col-lg-6 col-md-12 col-xs-12">
                ...
                <div class="team-item wow fadeInRight" data-wow-delay="0.8s">
                    <div class="team-img">
                        <img class="img-fluid" src="{{asset("domain/assets/img/team/team-04.png")}}" alt="">
                    </div>
                    <div class="contetn">
                        <div class="info-text">
                ...
                <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset("domain/assets/img/testimonial/img1.jpg")}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset("domain/assets/img/testimonial/img2.jpg")}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset("domain/assets/img/testimonial/img3.jpg")}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset("domain/assets/img/testimonial/img4.jpg")}}" alt="">
                            </div>
                            <div class="info">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                    <div class="widget">
                        <h3 class="footer-logo"><img src="{{asset("domain/assets/img/logo.png")}}" alt=""></h3>
...
<script src="{{asset("domain/assets/js/jquery-min.js")}}"></script>
<script src="{{asset("domain/assets/js/popper.min.js")}}"></script>
<script src="{{asset("domain/assets/js/bootstrap.min.js")}}"></script>
<script src="{{asset("domain/assets/js/owl.carousel.min.js")}}"></script>
<script src="{{asset("domain/assets/js/wow.js")}}"></script>
<script src="{{asset("domain/assets/js/jquery.nav.js")}}"></script>
<script src="{{asset("domain/assets/js/scrolling-nav.js")}}"></script>
<script src="{{asset("domain/assets/js/jquery.easing.min.js")}}"></script>
<script src="{{asset("domain/assets/js/main.js")}}"></script>
<script src="{{asset("domain/assets/js/form-validator.min.js")}}"></script>
<script src="{{asset("domain/assets/js/contact-form-script.min.js")}}"></script>
